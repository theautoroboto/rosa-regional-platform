...
variable "target_account_id" {
  description = "AWS account ID where the management cluster will be deployed (for cross-account assume role)"
  type        = string
  validation {
...
variable "target_region" {
  description = "AWS region where the management cluster will be deployed"
  type        = string
}